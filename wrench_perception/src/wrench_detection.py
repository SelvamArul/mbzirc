...
def main():
    ...
    template = cv2.imread('resource/wrench_big.png', 0)
    ...
    while count < 5 :
        ...
        p1 = (minLoc[0] - template.shape[1] / 2, minLoc[1] - template.shape[0] / 2)
        p2 = (minLoc[0] + template.shape[1] / 2, minLoc[1] + template.shape[0] / 2)
        cv2.rectangle(res, p1, p2, (255, 255, 255), thickness=-1)
